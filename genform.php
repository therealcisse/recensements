            ...
            <fieldset class="collapsible">
                ...
                <div class="box">
                    ...
                    <div class="formelement">
                        ...
                        <p class="select">
                            <input class="date-pick" name="EndDate" id="EndDate" type="text"  value="<?php echo date('Y-m-d') ?>"/>
                        </p>
                    </div>
                ...
                <div class="box">
                    ...
                    <div class="formelement">
                        ...
                        <p class="textarea">
                            <textarea style="width: 250px;" name="Keywords" id="Keywords" rows="7" cols="30"></textarea>
                        </p>
                    </div>
